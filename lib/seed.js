...
// generic page.
// A ready-to-go family day trip to the Toronto Islands, planned from Erin Mills,
// Mississauga: earliest all-day GO train from Clarkson into Union, ferry across,
// and a car-free biking day on the islands. Times are a sensible early-start
// plan — confirm the exact GO train + ferry departures the night before.
const TORONTO_ISLAND_DAY = {
  slug: "toronto-island-day",
  title: "Toronto Island Day",
  subtitle: "family bike day on the islands",
  date: "2026-07-02",
  emoji: "🚲",
  theme: "teal",
  vibe: "pastel",
  tags: ["Day trip", "Toronto Islands", "Family", "Biking", "GO train"],
  description:
    "Early GO train from Clarkson into Union, ferry over to the car-free Toronto Islands, and a full family day of biking, beaches, and Centreville. Kids 12 & under ride GO free with an adult. Bike rentals on Centre Island open late morning, so we start with the beach and the amusement park, then ride the flat, traffic-free paths midday. Times are an early-bird plan — double-check the exact GO train and ferry departures the night before on the GO Transit and Toronto Island ferry apps.",
  stops: makeStops([
    { time: "05:45", title: "Leave home & drive to Clarkson GO", place: "Clarkson GO Station", note: "~10 min from Erin Mills. Clarkson (Lakeshore West) runs all day, so the ride home isn't locked to rush hour. Free parking (arrive early for a spot), load Presto / grab tickets. Kids 12 & under ride free." },
    { time: "06:12", title: "Earliest GO train — Clarkson → Union", place: "Union Station Toronto", note: "Lakeshore West to Union, ~35 min. First trains leave Clarkson around 5–6 AM — grab an early one and CONFIRM the exact time on the GO app the night before." },
    { time: "06:55", title: "Breakfast & coffee at Union", place: "Union Station Toronto", note: "Quick bite in the Union food hall before the water. Fuel up — food on the island is limited and pricey." },
    { time: "07:25", title: "Down to the ferry terminal", place: "Jack Layton Ferry Terminal Toronto", note: "15-min walk to the lake, or hop the 509/510 streetcar to Queens Quay. Terminal is at the foot of Bay St." },
    { time: "07:50", title: "Ferry to Centre Island", place: "Centre Island Toronto", note: "Buy return tickets (cheaper online in advance). ~13 min across. Bikes are welcome onboard if you bring your own. Confirm the first sailing time." },
    { time: "08:20", title: "Boardwalk stroll + beach", place: "Centre Island Beach Toronto", note: "Beat the crowds — wander the boardwalk and hit the beach while it's quiet and cool." },
    { time: "09:30", title: "Centreville & Far Enough Farm", place: "Centreville Amusement Park Toronto", note: "Family rides (open ~10:30–11 in summer) plus the free petting farm next door — a hit with the kids." },
    { time: "11:00", title: "Rent bikes", place: "Toronto Island Bike Rental Centre Island", note: "Singles, tandems, and 4-person quadricycles for the whole family. Everything's flat and car-free." },
    { time: "12:00", title: "Bike to Gibraltar Point Lighthouse", place: "Gibraltar Point Lighthouse Toronto", note: "Ride the quiet west end to the historic lighthouse, then loop back along the boardwalk. Easy, scenic, traffic-free." },
    { time: "13:00", title: "Picnic lunch", place: "Centre Island Toronto", note: "Picnic on the grass by the pier (packing lunch is the move), or grab a bite at the Island Café / Carousel Café." },
    { time: "14:30", title: "Swim & splash pad", place: "Centre Island Beach Toronto", note: "Cool off — a swim at the beach or the splash pad near Centreville. Re-apply sunscreen." },
    { time: "16:00", title: "Return bikes & ferry back", place: "Jack Layton Ferry Terminal Toronto", note: "Drop the bikes and catch the ferry back — they run frequently through the summer afternoon." },
    { time: "16:45", title: "Early family dinner near Union", place: "St. Lawrence Market Toronto", note: "St. Lawrence Market or the Union food hall for an early dinner before the ride home." },
    { time: "18:10", title: "GO train home — Union → Clarkson", place: "Clarkson GO Station", note: "Lakeshore West back to Clarkson (~35 min), then the short drive home. Confirm the departure on the GO app." },
  ]),
  packing: makePacking([
    "Presto cards / GO tickets (kids 12 & under free)",
    "Sunscreen + hats + sunglasses",
    "Swimsuits + towels",
    "Reusable water bottles",
    "Picnic lunch + snacks",
    "Cash for the ferry + bike rental",
    "Light jacket — it's breezy on the water",
    "Bug spray",
    "Portable charger",
  ]),
  budget: makeBudget("$", 4, [
    { label: "GO train (adult return)", amount: 16, kind: "person", category: "transport" },
    { label: "Island ferry (adult return)", amount: 10, kind: "person", category: "transport" },
    { label: "Family bike rental (~2 hrs)", amount: 60, kind: "group", category: "fun" },
    { label: "Centreville ride wristbands", amount: 45, kind: "person", category: "fun" },
    { label: "Food, snacks & treats", amount: 30, kind: "person", category: "food" },
  ]),
};
...
function ensurePlannedContent() {
  ...
  ensureTrip(TORONTO_ISLAND_DAY, "Toronto Island day");
