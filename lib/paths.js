...
function resolveDataDir() {
  // Explicit override. The self-updater's pre-flight check sets this so it can
  // boot a freshly-downloaded build against a throwaway data folder to confirm
  // it actually serves — without ever touching the real db.json/sessions.
  if (process.env.TRIPPLANNER_DATA_DIR) return process.env.TRIPPLANNER_DATA_DIR;
